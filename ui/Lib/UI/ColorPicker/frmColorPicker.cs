...
namespace SeoulTransportationData.Lib.UI.ColorPicker
{
	/// <summary>
	...
	public class frmColorPicker : System.Windows.Forms.Form
	{
		...
		{
            SeoulTransportationData.Lib.UI.ColorPicker.AdobeColors.HSL hsl7 = new SeoulTransportationData.Lib.UI.ColorPicker.AdobeColors.HSL();
            SeoulTransportationData.Lib.UI.ColorPicker.AdobeColors.HSL hsl8 = new SeoulTransportationData.Lib.UI.ColorPicker.AdobeColors.HSL();
            ...
            this.m_ctrl_BigBox = new SeoulTransportationData.Lib.UI.ColorPicker.ctrl2DColorBox();
            this.m_ctrl_ThinBox = new SeoulTransportationData.Lib.UI.ColorPicker.ctrlVerticalColorSlider();
            ...
            // m_ctrl_BigBox
            // 
            this.m_ctrl_BigBox.DrawStyle = SeoulTransportationData.Lib.UI.ColorPicker.ctrl2DColorBox.eDrawStyle.Hue;
            hsl7.H = 0D;
            hsl7.L = 1D;
            hsl7.S = 1D;
            ...
            this.m_ctrl_BigBox.Scroll += new SeoulTransportationData.Lib.UI.ColorPicker.EventHandler(this.m_ctrl_BigBox_Scroll);
            // 
            // m_ctrl_ThinBox
            // 
            this.m_ctrl_ThinBox.DrawStyle = SeoulTransportationData.Lib.UI.ColorPicker.ctrlVerticalColorSlider.eDrawStyle.Hue;
            hsl8.H = 0D;
            hsl8.L = 1D;
            hsl8.S = 1D;
            ...
            this.m_ctrl_ThinBox.Scroll += new SeoulTransportationData.Lib.UI.ColorPicker.EventHandler(this.m_ctrl_ThinBox_Scroll);
            // 
            // frmColorPicker
            // 
		...
		{
			close_top.Image = Properties.Resources.close;
